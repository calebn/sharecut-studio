...
| Inspector | Selection details (clip, pending with Current/Suggested/A/B + Ask thread, track FX, chapter, social); unmapped pending list when idle; phone/tablet peek via bottom sheet |
