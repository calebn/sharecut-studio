...
quiet input never trigger it. Host heartbeats are unchanged. A late timer tick (throttled or background tab, laptop sleep) restarts the 5 s window instead of counting the gap as silence.
