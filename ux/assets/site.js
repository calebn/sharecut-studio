(() => {
  const ROUTES = {
    ...
    brief: { file: "brief.md", title: "Product brief", nav: "brief" },
    brand: { file: "brand.md", title: "Styling guidelines", nav: "brand" },
    demo: { file: "demo.md", title: "See the UI", nav: "demo" },
    screens: { file: "screen-inventory.md", title: "Screen inventory", nav: "screens" },
    journeys: { file: "guest-journeys.md", title: "Guest journeys", nav: "journeys" },
  ...
  function rewriteInternalLinks(html) {
    return html
      .replace(/href="#\/(brief|brand|demo|screens|journeys|glossary|backlog|shortcuts|home)?"/g, (m) => m)
  ...
  async function renderPage() {
    ...
    document.title = `${route.title} · Podcast MCP UX`;
    ...
    rawLink.href = `https://github.com/calebn/sharecut-studio/blob/main/ux/pages/${route.file}`;
